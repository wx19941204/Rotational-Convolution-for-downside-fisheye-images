...
class RotateCCDeformConv2D(nn.Module):
    ...
    def forward(self, input):
        ...
        # mask_stride = (img_size // h) * self.stride[0]
        # mask_stride = mask_stride + 1 if self.stride == 2 else mask_stride
        # mask = nn.AvgPool2d(kernel_size=1, stride=mask_stride)(self.mask)
...
class Rotate_2_CCDeformConv2D(nn.Module):
    ...
    def forward(self, input):
        ...
        # mask_stride = (img_size // h) * self.stride[0]
        # mask_stride = mask_stride + 1 if self.stride == 2 else mask_stride
        # mask = nn.AvgPool2d(kernel_size=1, stride=mask_stride)(self.mask).float()
